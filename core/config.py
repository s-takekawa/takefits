...
import yaml
import os
from PyQt6.QtWidgets import QWidget, QGridLayout, QLineEdit, QPushButton, QLabel, QMessageBox
...
class ConfigManager:
    def __init__(self, config_file=None):
        ...
        self.default_config = {
            ...
            'poslabel_x': 0.75,  # X position of the coordinate label
            'poslabel_y': 0.9,  # Y position of the coordinate label
