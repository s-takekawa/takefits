...
from PyQt6.QtCore import QTimer # Import QTimer for delayed execution
import json
import traceback
import os
import numpy as np
...
# from core.common import Common # May still be needed for fallback or direct access # Commented out as not directly used in the provided snippet modifications
from tools.color_scale import ColorSettingsPanel, ColorMode # Dependency for applying color settings
# Import necessary window types if accessing their panels
from tools.integration import IntegResultWindow # Assuming this holds the panel
from tools.channel_map import ChannelMapWindow # Assuming this holds the panel
